...
## Company Login & Register Form

class ComLoginForm(forms.Form):
...
class ComRegisterForm(forms.Form):
    username = forms.CharField(label='Company Name', widget=forms.TextInput)
    email = forms.EmailField(label='Company Email', widget=forms.EmailInput)
